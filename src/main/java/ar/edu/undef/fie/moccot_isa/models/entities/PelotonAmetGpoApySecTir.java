...
public class PelotonAmetGpoApySecTir  {
    @Id
    ...
    public PelotonAmetGpoApySecTir(){}

    public PelotonAmetGpoApySecTir(String nombre, List<Personal> personal, Integer cantidadMaximaDePersonas) {
        this.nombre = nombre;
    ...
    public PelotonAmetGpoApySecTir(String nombre) {
        this.nombre = nombre;
